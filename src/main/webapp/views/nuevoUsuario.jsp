...
<%@include file="/views/partials/header.jsp"%>
    ...
    <main class="h-75 d-flex justify-content-center align-items-center bg-info-subtle mb-3">
        ...
        <div class="h-50 w-50 d-flex flex-column justify-content-between align-items-center py-4 px-4 rounded bg-acero">
            ...
            switch (estadoRegistro) {
                case 1: %>
                    <h3 class='text-success mb-5 fs-3'>¡Registro exitoso!</h3>
                <%    break;
            }
            %>

            <a href="/<%=proyecto%>/views/login.jsp" class="btn btn-secondary">Volver</a>
